from backbone import BasicResNetBackbone, ResNetBackbone, VGGBackbone, ResNetBackboneGN, DarkNetBackbone
...
resnet34_backbone = resnet101_backbone.copy({
    ...
    'type': BasicResNetBackbone,
    'args': ([3, 4, 6, 3],),   # <- number layer (ref: look on resnet paper in the table part)
    'transform': resnet_transform,
})
...
resnet18_backbone = resnet101_backbone.copy({
    ...
    'type': BasicResNetBackbone,
    'args': ([2, 2, 2, 2],),   # <- https://github.com/pytorch/vision/blob/master/torchvision/models/resnet.py
    'transform': resnet_transform,
})
###########################################################
